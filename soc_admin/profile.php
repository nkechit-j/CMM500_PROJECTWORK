        ...
        <div class="container mt-5">
            <div class="row justify-content-center">
                ...
                <form class="update_profile_form">
                    ...
                    <input type="email" class="form-control" id="email"  name="email" value ="<?= $t->getAdminById($_SESSION["_USER_ID"])['admin_email']?>" placeholder="Enter your email" required />
                    </div>
                    <div class="form-group">
                    <label for="username">Username</label>
                    <input type="text" class="form-control" id="username"  name="username" value ="<?= $t->getAdminById($_SESSION["_USER_ID"])['admin_username']?>" placeholder="Enter your username" required />
                    </div>
